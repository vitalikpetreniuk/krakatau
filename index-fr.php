...
<head>
	...
	<meta name="description" content="Localisez votre contenu dans 14 langues populaires au meilleur CPM et augmentez vos revenus.">
			...
			<section id="about" class="kr-section kr-section_about">
                <div class="about-video">
                    <div class="container">
                        ...
                        <div class="video">
                            <div class="youtube" data-embed="jMj_ZkVvAvo"><div class="play-button"></div></div>
                        </div>
                    </div>
                </div>
