...
<head>
    ...
    <meta name="description" content="使用擁有最高CPM的14門受歡迎語言本土化您的內容，獲得收益成長">

    <link rel="canonical" href="https://krakatau.pro/ch">
			...
			<section id="about" class="kr-section kr-section_about">
                <div class="about-video">
                    <div class="container">
                        ...
                        <div class="video">
                            <div class="youtube" data-embed="BjN21T_30_s"><div class="play-button"></div></div>
                        </div>
                    </div>
                </div>
