...
<head>
	...
	<meta name="description" content="Localize seu conteúdo nos 14 idiomas mais populares com o maior CPM para aumento do rendimento.">
			...
			<section id="about" class="kr-section kr-section_about">
                <div class="about-video">
                    <div class="container">
                        ...
                        <div class="video">
                            <div class="youtube" data-embed="ffAc20wrW50"><div class="play-button"></div></div>
                        </div>
                    </div>
                </div>
